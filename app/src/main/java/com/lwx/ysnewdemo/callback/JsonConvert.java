 ...
 */
package com.lwx.ysnewdemo.callback;

import com.google.gson.stream.JsonReader;
import com.lwx.ysnewdemo.model.SimpleResponse;
import com.lwx.ysnewdemo.rx.LwxResponse;
import com.lwx.ysnewdemo.utils.Convert;
    ...
    private T parseParameterizedType(Response response, ParameterizedType type) throws Exception {
        ...
        if (rawType != LwxResponse.class) {
            ...
            if (typeArgument == Void.class) {
                ...
                LwxResponse lzyResponse = Convert.fromJson(jsonReader, type);
                response.close();
                int code = lzyResponse.errcode;
                //这里的0是以下意思
